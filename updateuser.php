...
if(isset($_POST['name'],$_POST['address'],$_POST['gender'],$_POST['phone']))
{
	$name=$_POST['name'];
	...
	$sql = "UPDATE `userregistration` SET `name`='$name',`address`='$address',`gender`='$gender',`phone`='$phone' WHERE `email`='$email'";
	if ($con->query($sql) === TRUE) 
	{
		echo "<script>alert('User Details Suucessfully Updated!!'); location.href='userprofile.php';</script>";
	} 
	else 
	{
